...
import 'package:clubevent/ui/pages/chat/messages/widgets/message.dart';
import 'package:clubevent/ui/pages/chat/messages/widgets/option.dart';
...
class ChatView extends StatefulWidget {
  ...
  final Future<void> Function(Mensaje message) updateChat;
                            ...
                            DeleteMessage(
                              ...
                              onDelete: () async {
                                if (message.reference == items[0].reference) {
                                  Mensaje newLastMessage = items[1];
